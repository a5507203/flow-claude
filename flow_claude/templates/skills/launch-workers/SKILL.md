...
description: |
  ...
  python -m flow_claude.scripts.create_task_branch \
    ...
    --depends-on='[]' --key-files='["src/api/register.py","tests/test_register.py"]' --priority="high"
