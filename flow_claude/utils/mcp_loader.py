...
Loads MCP server configurations from project's .flow-claude/.mcp.json file.
"""
...
def load_project_mcp_config(project_dir: Optional[Path] = None) -> Dict[str, Any]:
    """Load MCP server configurations from project's .flow-claude/.mcp.json.
    ...
    mcp_json_path = project_dir / ".flow-claude" / ".mcp.json"
